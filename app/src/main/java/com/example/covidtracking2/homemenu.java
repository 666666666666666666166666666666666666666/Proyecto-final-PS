...
import com.example.covidtracking2.Activity.Activity.LoginActivity;
import com.example.covidtracking2.Activity.Activity.MenuActivity;
...
public class homemenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        botonMedico.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(),MainActivityChat.class);
                startActivityForResult(intent, 0);
        ...
        botonCentros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(), MainActivitySalud.class);
                startActivityForResult(intent, 0);
