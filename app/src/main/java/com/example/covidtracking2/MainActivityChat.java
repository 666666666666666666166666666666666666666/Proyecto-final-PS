...
import com.example.covidtracking2.Activity.Activity.RegistroActivity;
...
private ImageView fotoPerfil;
    ...
    private Button btnEnviar,BotonChatLogin1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BotonChatLogin1=(Button)findViewById(R.id.BotonChatLogin);
        ...
        BotonChatLogin1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                startActivity(new Intent(com.example.covidtracking2.MainActivityChat.this, com.example.covidtracking2.Activity.Activity.LoginActivity.class));
               // Intent i=new Intent(MainActivityChat.this,  com.example.covidtracking2.Activity.Activity.LoginActivity.class);
                //startActivity(i);
            }
        });
