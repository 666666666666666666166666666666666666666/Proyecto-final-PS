...
public class FragmentEval1 extends Fragment {
    ...
    EditText editTextedad,textViewevalnombre;
    TextView evalres,evalres1,evalres3;
    Button botonevalua,buttonEnviarlista,botonevaluaedad;
    String caso;
    int edad;
    double res;
    // int a=4,b=7,c=8,d=9;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonEnviarlista=(Button)v.findViewById(R.id.buttonEnviarlista);
        textViewevalnombre=(EditText)v.findViewById(R.id.editTextNombre);
...
//
        ...
        buttonEnviarlista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(), NotEvallisActivity.class);
                startActivityForResult(intent, 0);
                intent.putExtra("nombre",textViewevalnombre.getText().toString());
                startActivity(intent);
                intent.putExtra("porcentage",evalres.getText().toString());
                startActivity(intent);
