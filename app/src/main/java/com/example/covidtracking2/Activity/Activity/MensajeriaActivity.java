...
import com.example.covidtracking2.Adaptadores.MensajeriaAdaptador;
...
import com.example.covidtracking2.Persistencia.Persistencia.MensajeriaDAO;
                ...
                if(mapUsuariosTemporales.get(mensaje.getKeyEmisor())!=null){
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(com.example.covidtracking2.Activity.Activity.MensajeriaActivity.this, "Error: "+error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
