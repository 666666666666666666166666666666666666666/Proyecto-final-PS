...
public class UsuarioDAO {
    ...
    private static com.example.covidtracking2.Persistencia.Persistencia.UsuarioDAO usuarioDAO;
    private FirebaseDatabase database;
    private FirebaseStorage storage;
    private DatabaseReference referenceUsuarios;
    private StorageReference referenceFotoDePerfil;

    public static com.example.covidtracking2.Persistencia.Persistencia.UsuarioDAO getInstancia(){
        if(usuarioDAO==null) usuarioDAO = new com.example.covidtracking2.Persistencia.Persistencia.UsuarioDAO();
        return usuarioDAO;
    }
