       ...
       // codi=findViewById(R.id.editTextCode);
        ...
        ButtonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(RegistryUser.this,""+password,Toast.LENGTH_SHORT).show();
               ...
               age=Integer.parseInt(dbedad);
                ...
                if(!dbnombre.isEmpty() &&!dbedad.isEmpty()&&!dbapellido.isEmpty()&&!dbci.isEmpty()&&!dbemail.isEmpty()&& !dbpassword.isEmpty()){
                        ...
                        if(dbpassword.length()>=6&&dbci.length()>=6&&dbci.length()<=8){
                            if(age>=5&&age<=80)
                            {
                                registerUser();
                            }else{
                        ...
                        Toast.makeText(RegistryUser.this,"El password  debe tener al menos 6 caracteres o el CI incorrecto",Toast.LENGTH_SHORT).show();
                    }
                }
