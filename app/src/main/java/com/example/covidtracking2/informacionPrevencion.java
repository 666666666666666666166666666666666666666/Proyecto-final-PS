...
public class informacionPrevencion extends AppCompatActivity implements View.OnClickListener {
    ...
    VideoView videoView;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            //define el video en linea
            videoView=(VideoView)findViewById(R.id.video);

       /* Uri uri= Uri.parse("https://redemc.net/campus/recomendaciones-para-protegerse-y-prevenir-la-propagacion-del-coronavirus");
        videoView.setMediaController(new MediaController(this));
        videoView.setVideoURI(uri);
        videoView.requestFocus();
        videoView.start();*/
            videoView.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.videocovid);
